...
interface MyResponseDetailPageProps {
  params: Promise<{ responseId: string }>;
}

export default async function MyResponseDetailPage({ params }: MyResponseDetailPageProps) {
  ...
  // Teknisi can only see their own responses
  ...
  return (
    <div className="space-y-6 max-w-3xl mx-auto">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="text-2xl font-bold tracking-tight">Detail Pengisian</h1>
      ...
      <Card>
        <CardHeader>
          <CardTitle>Informasi Pengisian</CardTitle>
        </CardHeader>
